...
!function ($) {
    ...
    $.fn.validation.defaults = {
        validRules: [
            ...
            { name: 'number', validate: function (value) {/*此处增加空值判断lf*/ if ($.trim(value) == '') return false; return (!/^[0-9]\d*$/.test(value)); }, defaultMsg: '请输入数字。' },
            { name: 'mail', validate: function (value) {/*此处增加空值判断lf*/ if ($.trim(value) == '') return false; return (!/^[a-zA-Z0-9]{1}([\._a-zA-Z0-9-]+)(\.[_a-zA-Z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+){1,3}$/.test(value)); }, defaultMsg: '请输入邮箱地址。' },
            { name: 'char', validate: function (value) {/*此处增加空值判断lf*/ if ($.trim(value) == '') return false; return (!/^[a-z\_\-A-Z]*$/.test(value)); }, defaultMsg: '请输入英文字符。' },
            { name: 'chinese', validate: function (value) {/*此处增加空值判断lf*/ if ($.trim(value) == '') return false; return (!/^[\u4e00-\u9fff]$/.test(value)); }, defaultMsg: '请输入汉字。' }
        ]
    };
