...
namespace MedQC.Web.Areas.Admin.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        public ActionResult GetTreeJson() {
            ...
            var result = EnterRepository.GetRepositoryEnter().CategoryRepository.GetCategorys("").ToList();
            result.Add(new Category() { ID = 0, Name = "根节点", ParentID = -1 });
            szJson = JsonHelper.GetCategoryTreeJson(result, -1);
        ...
        public ActionResult GetComboxTreeJson()
        {
            ...
            string szJson = string.Empty;
            var result = EnterRepository.GetRepositoryEnter().CategoryRepository.GetCategorys(categoryCode).ToList();
            szJson = JsonHelper.GetCategoryTreeJson(result, 0);
            //szJson = "[{\"ID\":\"1\",\"Name\":\"hello1\",\"ParentID\":\"0\"},{\"ID\":\"2\",\"Name\":\"hello2\",\"ParentID\":\"1\"}]";
            return Content(szJson);
            //return Json(result, JsonRequestBehavior.AllowGet);
        }
