...
namespace MedQC.Web.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.Hotel = HotelServices.GetHotels(SystemConst.CategoryCode.Hotel, order, 1, 12, out totalCount);
            ViewBag.Blog = BlogServices.GetBlogs(0,SystemConst.CategoryCode.Blog, order, 1, 10, out totalCount);
            return View();
        }
